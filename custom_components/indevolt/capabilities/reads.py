"""Home Assistant entities for documented OpenData read points."""
...
def _translation_key(name: str) -> str:
    """Return a stable translation key for one new entity."""
...
BK_GET_USER_CAPABILITIES: tuple[GetUserCapability, ...] = (
    ...
    GetUserCapability(
        ...
        domain="binary_sensor",
        key="2618",
        name="Grid Charging Permission",
        translation_key="grid_charging_permission",
        sample_value=1001,
        expected_state="on",
