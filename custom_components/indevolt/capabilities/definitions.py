"""Shared definitions for OpenData user capabilities."""
...
class GetUserCapability:
    """One entity and the documented meaning of its raw values."""
    ...
    def unique_id(self, serial: str) -> str:
        """Return the stable unique ID for this entity."""
...
class SetUserCapability:
    """One user control or an explicitly non-user write."""
