...
async def test_solidflex2000_handles_each_new_value_disappearing(
    capability: GetUserCapability,
) -> None:
...
async def test_solidflex2000_does_not_duplicate_non_user_read_points(
    point: int,
) -> None:
...
async def test_solidflex2000_handles_each_new_control_readback_disappearing(
    capability: SetUserCapability,
) -> None:
...
async def test_solidflex2000_keeps_each_non_user_write_point_out_of_ha_controls(
    capability: SetUserCapability,
) -> None:
