"""PowerFlex2000 polling-point contract."""
...
@pytest.mark.asyncio
async def test_powerflex2000_polls_its_own_point_contract() -> None:
    api = RecordingAPI()
...
@pytest.mark.asyncio
async def test_powerflex2000_polls_each_additional_read_point(point: int) -> None:
...
@pytest.mark.asyncio
async def test_powerflex2000_polls_each_remaining_documented_read_point(
    point: int,
) -> None:
    api = RecordingAPI()
    coordinator = object.__new__(IndevoltDeviceUpdateCoordinator)
