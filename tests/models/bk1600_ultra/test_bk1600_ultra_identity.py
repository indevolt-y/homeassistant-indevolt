"""BK1600Ultra entity identity contract."""
...
def test_bk1600_ultra_sensor_uses_its_config_entry_identity() -> None:
    ...
    assert entity.unique_id == "bk1600-ultra-entry_1664"
    assert entity.device_info == {
        "identifiers": {(DOMAIN, "BK1600-ULTRA-SN")},
        "name": f"{MODEL} (BK1600-ULTRA-SN)",
        "manufacturer": "INDEVOLT",
        "sw_version": "2.0.0",
        "model": MODEL,
        "serial_number": "BK1600-ULTRA-SN",
    }


def test_bk1600_ultra_controls_share_its_config_entry_identity() -> None:
    ...
    assert [entity.unique_id for entity in entities] == [
        "bk1600-ultra-entry_power_setting",
        "bk1600-ultra-entry_state_setting",
    ]
    assert all(
        entity.device_info["identifiers"] == {(DOMAIN, "BK1600-ULTRA-SN")}
